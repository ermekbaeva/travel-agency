...
INSERT INTO `clients` VALUES (23,'MARIA','IVANOVA','IVANOVA@GMAIL.COM',NULL),(24,'nina','smith','smith@gmail.com',NULL);
...
CREATE TABLE `reservation` (
  ...
  KEY `Id_tour` (`Id_tour`),
  CONSTRAINT `reservation_ibfk_1` FOREIGN KEY (`Id_client`) REFERENCES `clients` (`Id_client`),
  CONSTRAINT `reservation_ibfk_2` FOREIGN KEY (`Id_tour`) REFERENCES `tours` (`Id_tour`)
...
-- Dump completed on 2021-09-03 13:54:17
